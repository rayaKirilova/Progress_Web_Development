...
for (i = 0 ; i < rulers.length ; i++){
    let rulerArray = rulers[i] ; 

    let rulerName = rulerArray[0] ; 
    let rulerYears = rulerArray[2] - rulerArray[1] ; 

    if (rulerYears > 15){
        console.log(toCamelCaseCyr(rulerName) + ` е управлявал ${rulerYears} години.`) ; 
    }
}
